...
trait Contact
{
    ...
    function getMeditationDownloadTemplate($email)
    {
        return "<table width='100%' cellpadding='0' cellspacing='0' style='font-family: Arial, sans-serif; background-color: #f6f4f1; padding: 30px;'>
                    <tr>
                        <td align='center'>
                            <table width='600' cellpadding='0' cellspacing='0' style='background-color: #ffffff; border-radius: 12px; overflow: hidden; border: 1px solid #eee;'>
                                ...
                                <tr>
                                    <td style='text-align: center; padding: 28px 20px; background: #daa520;'>
                                        ...
                                        <p style='margin: 6px 0 0; font-size: 14px; color: #fff;'>
                                            Sleeping Meditation File Downloaded
                                        </p>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td style='padding: 30px 30px 20px; color: #333333; font-size: 15px; line-height: 1.7;'>
                                        <p style='margin-top: 0;'>
                                            Someone Just Downloaded The Sleeping Meditation File ✨
                                        </p>
    ...
    function getRoadmapDownloadTemplate($email)
    {
        return "<table width='100%' cellpadding='0' cellspacing='0' style='font-family: Arial, sans-serif; background-color: #f6f4f1; padding: 30px;'>
                    <tr>
                        <td align='center'>
                            <table width='600' cellpadding='0' cellspacing='0' style='background-color: #ffffff; border-radius: 12px; overflow: hidden; border: 1px solid #eee;'>
                                ...
                                <tr>
                                    <td style='padding: 30px 30px 20px; color: #333333; font-size: 15px; line-height: 1.7;'>
                                        <p style='margin-top: 0;'>
                                            Someone Just Downloaded The Roadmap File ✨
                                        </p>
    ...
    function getMasterclassDownloadTemplate($email)
    {
        return
            "<table width='100%' cellpadding='0' cellspacing='0' style='font-family: Arial, sans-serif; background-color: #f6f4f1; padding: 30px;'>
                    <tr>
                        <td align='center'>
                            <table width='600' cellpadding='0' cellspacing='0' style='background-color: #ffffff; border-radius: 12px; overflow: hidden; border: 1px solid #eee;'>
                                ...
                                <tr>
                                    <td style='padding: 30px 30px 20px; color: #333333; font-size: 15px; line-height: 1.7;'>
                                        <p style='margin-top: 0;'>
                                           Someone Just Applied For LFG Publish
                                        </p>
                                ...
                                <tr>
                                    <td style='background-color: #fafafa; color: #777; font-size: 12px; text-align: center; padding: 18px 30px;'>
                                        This message was sent via the <strong>Write Naked Method</strong>  website.<br>
                                    </td>
                                </tr>
