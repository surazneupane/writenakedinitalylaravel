...
<footer id="contact">
    <div class="container">
        @if (!$hideDescription)
            <div style="text-align: center; margin-bottom: 20px" class="kicker">
            ...
            <div
                ...
                margin-bottom: 12px;
            ">
                <span class="pill">📍 &nbsp; Lecce, Italy</span>
                <span class="pill">📅 &nbsp; February 17–21, 2026</span>
                <span class="pill">💖 &nbsp; Love-Themed Retreat</span>
            </div>

            <p class="muted" style="text-align: center; margin-bottom: 16px;">
                Write Naked in <strong> Love </strong>. Publish in <strong> Passion </strong>. Become a <strong>
                    Bestseller
                </strong>.
            </p>
        @endif
        <div class="footer-social" style="margin-bottom: 16px;">
            <div>
                <a href="https://www.facebook.com/mirav.tarkka" target="_blank" aria-label="Facebook">
            ...
            <div>
                <a href="https://www.instagram.com/miravtarkka/" target="_blank" aria-label="Instagram">
                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="40" height="40"
                        viewBox="0 0 48 48">
        ...
        <p class="muted" style="text-align: center">
            © <span id="y"></span> Write Naked Method — All rights reserved.
        </p>
    </div>
</footer>
