...
<div id="newsletterModal" class="modal-overlay">
    <div class="modal-content">
        ...
        <div class="modal-header">
            ...
            <h1>Sleep your way to bestselling authorship</h1>
            <p class="subtitle">Enter your email to download the sleeping meditation audio.</p>
        </div>
            ...
            <form id="subscriptionForm">
                ...
                <div class="file-card">
                    ...
                    <div class="file-details">
                        <span class="file-name">Write Naked & Wild Bestselling Author Sleeping meditation</span>
                        <span class="file-meta">Audio MP3 • 9.9 MB</span>
                    </div>
                </div>
